...
class CustomDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, transform = None, train = True):
        ...
        # trainとval用で分ける
        if train == True:
            mnist_0_path = os.path.join(root, "training500", "0")
            mnist_1_path = os.path.join(root, "training500", "1")
            mnist_2_path = os.path.join(root, "training500", "2")
            mnist_3_path = os.path.join(root, "training500", "3")
            mnist_4_path = os.path.join(root, "training500", "4")
            mnist_5_path = os.path.join(root, "training500", "5")
            mnist_6_path = os.path.join(root, "training500", "6")
            mnist_7_path = os.path.join(root, "training500", "7")
            mnist_8_path = os.path.join(root, "training500", "8")
            mnist_9_path = os.path.join(root, "training500", "9")
        else:
            mnist_0_path = os.path.join(root, "all", "0")
            mnist_1_path = os.path.join(root, "all", "1")
...
class GenDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, transform = None, train = True):
        ...
        if train == True:
            mnist_0_path = os.path.join(root, "all", "0")
            mnist_1_path = os.path.join(root, "all", "1")
            mnist_2_path = os.path.join(root, "all", "2")
            mnist_3_path = os.path.join(root, "all", "3")
            mnist_4_path = os.path.join(root, "all", "4")
            mnist_5_path = os.path.join(root, "all", "5")
            mnist_6_path = os.path.join(root, "all", "6")
            mnist_7_path = os.path.join(root, "all", "7")
            mnist_8_path = os.path.join(root, "all", "8")
            mnist_9_path = os.path.join(root, "all", "9")
        else:
